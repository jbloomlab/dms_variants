# -*- coding: utf-8 -*-
#
# dms_variants documentation build configuration file.
#
...
versionfile = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../dms_variants/__init__.py")
)
...
htmlhelp_basename = "dms_variantsdoc"
...
man_pages = [(master_doc, "dms_variants", "dms_variants Documentation", [author], 1)]
